% Main entrance of Single Watermarking embedding with FE(Wang) to Formant 
%%% By WANG Shengbei
%%% 2015 7/24
%%% Shengbei Wang
...
OutFolder = 'E:\ALL_Program_WANG\Hybrid_Watermarking_QIM_FE\Proposed_QIM_FE\Single_WM_FE_8.1_sec_speech\';
...
for k = 1:12 % for speech 
   ...
   for kk=1:Bit_list_length
         ...
         [out_speech WMs_embed] = Embed_Function_Single_FE(xt,WM_sequence_data,p);
         Real_Bps=Bps/p.Dup;
         cd(OutFolder)
         Output_name=['WM_FE_Bps' num2str(Real_Bps) '_00' num2str(k) '.wav'];
