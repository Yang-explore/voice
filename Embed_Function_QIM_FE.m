% Function of Embed watermarks with FE to formant and QIM to residue
%%% By WANG Shengbei
%%% 2015 7/21

function [out_speech WMs_Real_embed] = Embed_Function_QIM_FE(xt, WMs, p)
Xt_Length = length(xt);
...
%%%%%%%%%%%%Embedding watermarks into Residue (QIM)%%%%%%%%%%%%%%%%%%%%%%%%% 
    ...
    cur_speech_recons=filter(1,[1,LP_modify_back(2:end)],WM_Residue);
