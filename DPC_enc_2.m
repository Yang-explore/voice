%function [yt,enc_dat] = DPC_enc_2(xfile, p, dat, steps)
...
clc;
InFolder  = '/home/wang/Doctor_Materials/Hybrid_Watermarking_QIM_FE/Original_8.1_sec_speech/';
OutFolder=['/home/wang/Doctor_Materials/Hybrid_Watermarking_QIM_FE/Hybrid_WM_QIM_FE_8.1_sec_speech/'];
Function_Folder = '/home/wang/Doctor_Materials/Hybrid_Watermarking_QIM_FE/';


      cur_speech=[InFolder 'orgsound_8.1sec_001.wav'];
...
steps = [pi/2 pi/4 pi/6 pi/8 pi/10]';
nfr = floor(size(xt,1)/frlen);
yt = zeros(size(xt));
dat=round(rand(1,10000))';
